	...
	return &compatState{
		...
		models: []map[string]any{
			...
			},
			{
				...
				"provider":   "groq",
				"capability": "reasoning",
				"aliases":    []string{"llama-3.3", "groq-70b"},
			},
			{
				...
				"provider":   "groq",
				"capability": "fast-response",
				"aliases":    []string{"llama-3.1-8b", "groq-8b"},
			},
			{
				"id":         "glm-5",
				"name":       "GLM-5",
				...
				"provider":   "zhipuai",
				"capability": "reasoning",
				"aliases":    []string{"zhipu-glm-5", "bigmodel-glm-5"},
			},
			{
				"id":         "glm-5",
				"name":       "GLM-5 (Z.ai)",
			...
			},
			{
				...
				"provider":   "zai",
				"capability": "reasoning",
				"aliases":    []string{"zai-glm-4.5-air", "glm-4-5-air"},
			},
			{
